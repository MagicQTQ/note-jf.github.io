...
![img](./基础结构与语法.assets/true-clip_image002.jpg)
...
![img](./基础结构与语法.assets/true-clip_image004.jpg)
...
![img](./基础结构与语法.assets/true-clip_image006.jpg)
...
![img](./基础结构与语法.assets/true-clip_image008.jpg)

![img](./基础结构与语法.assets/true-clip_image010.jpg)

![img](./基础结构与语法.assets/true-clip_image012.jpg)
...
![img](./基础结构与语法.assets/true-clip_image014.jpg)

全局变量-成员变量

![img](./基础结构与语法.assets/true-clip_image016.jpg)
...
![img](./基础结构与语法.assets/true-clip_image018.jpg)

注意事项：如果给变量的值草出了变量类型的取值范围，就会出点问题

例如：![img](./基础结构与语法.assets/true-clip_image020.jpg)
...
![img](./基础结构与语法.assets/true-clip_image022.jpg)

![img](./基础结构与语法.assets/true-clip_image024.jpg)
...
注意：默认的小数值就是double类型![img](./基础结构与语法.assets/true-clip_image026.jpg)

Float f=54.321会产生编译错误，![img](./基础结构与语法.assets/true-clip_image028.jpg)

在后面加f，解决编译问题![img](./基础结构与语法.assets/true-clip_image030.jpg)

![img](./基础结构与语法.assets/true-clip_image032.jpg)
...
![img](./基础结构与语法.assets/true-clip_image034.jpg)
...
![img](./基础结构与语法.assets/true-clip_image036.jpg)编译会出问题

使用完整英文单词名称，而非缩写

![img](./基础结构与语法.assets/true-clip_image038.jpg)

不能使用关键字

![img](./基础结构与语法.assets/true-clip_image040.jpg)凡是系统自带的具有特殊意义的关键字，通通不能作为变量名称
...
![img](./基础结构与语法.assets/true-clip_image042.jpg)
...
![img](./基础结构与语法.assets/true-clip_image044.jpg)
...
![img](./基础结构与语法.assets/clip_image046.jpg)
...
![img](./基础结构与语法.assets/true-clip_image048.jpg)

Final代表最终状态，不可以被修改

### 在声明的时候没有赋值

![img](./基础结构与语法.assets/true-clip_image050.jpg)

如果在声明的时候没有赋值，可以在后面的代码中国赋值唯一一次——final修饰的

### Final可以修饰类也可以修饰方法

![img](./基础结构与语法.assets/true-clip_image052.jpg)
...
![img](./基础结构与语法.assets/true-clip_image054.jpg)

## 表达式

以分号结尾的代码就是一个表达式

![img](./基础结构与语法.assets/true-clip_image056.jpg)

单一的； 分号，就是一个完整的表达式

![img](./基础结构与语法.assets/true-clip_image058.jpg)
...
![image-20220530185209145](./基础结构与语法.assets/true-image-20220530185209145.png)
